...
class ParcelForm(FlaskForm):
    sender_name = StringField('Sender', validators=[DataRequired(), Length(max=100)])
    sender_email = StringField('Email', validators=[DataRequired(), Email(), Length(max=100)])
    sender_contact = StringField('Senders Contact', validators=[DataRequired(), Length(max=20)])
    receiver_name = StringField('Receivers Name', validators=[Length(max=100)])
    receiver_contact = StringField('Receivers Contact', validators=[Length(max=20)])
